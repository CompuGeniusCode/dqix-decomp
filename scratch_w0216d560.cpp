...
// USA: func_ov000_0216d560
ARM void SomeFunc_0216d560(struct Obj0216d560* obj, int id) {
    ...
    if (!c) {
        ...
        tbl.x = GetTableEntryEven02030c68(fieldB.y);
        tbl.y = 0;
        tbl.z = GetTableEntryOdd02030c9c(fieldB.y);
