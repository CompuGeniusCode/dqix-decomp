...
ARM int ProcessNodeEventOrTick_0215d534(void* obj) {
...

    {
        ...
        if (func_0202c508(state)) {
            ...
            if (thresh <= c->low7) {
                func_ov004_0215c0c0(obj);
                EnqueueEventTag184_021d3bbc(field5c * 6 + code, data_ov004_021707d8.ptr[0x11], 1, 0);
                goto end;
            }
        ...
        if (!TestFlagBitAt0xe((struct SearchStruct*)state, 0)) {
            ...
            *(unsigned short*)(p + 0xc) = v;
            EnqueueEventTag184_021d3bbc(field5c * 6 + code, data_ov004_021707d8.ptr[0x11], 3, 0);
