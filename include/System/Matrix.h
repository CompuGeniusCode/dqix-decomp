...
{
#endif
    // usa: Mat3x3_WriteIdentity
    void Mat3x3_WriteIdentity(Matrix3x3* out);
    // usa: Mat3x3_ApplyScale
    ...
    // usa: Mat4x4_WriteIdentity
    void Mat4x4_WriteIdentity(Matrix4x4* out);
    // usa: Mat4x4_ConvertTo4x3
    ...
    // usa: Mat4x4_WriteProjectionUnknown
    ...
    // usa: GetHardwareDividerResult
    int64_t GetHardwareDividerResult();
    // usa: fix32_GetDivisionResult
    ...
    // usa: fix32_QueueComputeReciprocal
