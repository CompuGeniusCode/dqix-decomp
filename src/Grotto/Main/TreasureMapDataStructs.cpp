...
// Independently decompiled elsewhere under descriptive names before this
// file was adopted; alias the placeholder identifiers used in this file
// to those real (already-matching) symbols.
