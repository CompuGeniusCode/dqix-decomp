...
extern "C" int func_ov031_0220ff78(int* obj);
int IsField0Unchanged_0220ff18(void* obj);
void WaitForField2CNonZero_0220fea0(void);
void ClearField28SetField2C_0220fed8(void);

// USA: func_ov031_0220fc80  (semantic: RegisterAndAwaitMsgD2_0220fc80)
extern "C" ARM void func_ov031_0220fc80(void) {
	Header0220fc80 hdr;
	...
	if (func_ov031_0220fe44(func_ov031_0220ff78) != 0) {
