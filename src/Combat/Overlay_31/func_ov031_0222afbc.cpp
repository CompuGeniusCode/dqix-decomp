...
extern "C" void func_ov031_0222b010(void);

// USA: func_ov031_0222afbc  (semantic: CallStubsThenSetHandler_0222afbc)
extern "C" ARM void func_ov031_0222afbc(void) {
	func_ov031_0223c078(2, 1, 1, 8);
	func_ov031_0223c078(2, 0, 0x15, 8);
	func_ov031_0223cb68(1, 1);
	func_ov031_0223cb68(0, 0x15);
	SetField_022274c0_022274c0((int)func_ov031_0222b010);
}
