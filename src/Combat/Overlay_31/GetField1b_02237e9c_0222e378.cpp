...
extern "C" void func_ov031_0222e3a4(void);

// USA: func_ov031_0222e378
ARM void AdvanceUnlessField1bActive_0222e378(void) {
    if (GetField1b_02237e9c() != 0) {
        return;
    }
    func_ov031_02236878(6);
    func_ov031_02237e58();
    SetField_022274c0_022274c0((int)func_ov031_0222e3a4);
}
