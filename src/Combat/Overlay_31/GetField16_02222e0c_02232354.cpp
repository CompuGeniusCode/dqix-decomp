...
void RegisterCallback_02232380(void);

// USA: func_ov031_02232354
ARM void AdvanceUnlessField16Active_02232354(void) {
    if (GetField16_02222e0c() != 0) {
        return;
    }
    CallFunc020bc548AtOffset94_022368e0();
    TailCallOffset94_02236878(7);
    SetField_022274c0_022274c0((int)RegisterCallback_02232380);
}
