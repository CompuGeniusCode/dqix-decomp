...
extern "C" ARM int func_ov000_0216c144(struct Variant02030b0c* v, int argc) {
    ...
    node->unused = 0;
    node->tag = 0x5b;
    node->byte8 = (unsigned char)GetIntFromVariant02030b0c(v);
    node->byte9 = (unsigned char)GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)v + 8));
    if (argc >= 3) {
        char* src = GetField4IfField0Zero((struct Struct02030b7c*)((char*)v + 0x10));
