...
extern "C" ARM int func_ov000_0216c9fc(struct Variant02030b0c* v) {
    ...
    int type = GetIntFromVariant02030b0c(v);
    node->type = (unsigned char)type;
    switch (type & 0xff) {
    case 0:
        node->x = (short)(int)(4096.0f * GetTaggedValueAsFloat((struct TaggedValue02030b44*)((char*)v + 8)));
        node->y = (short)(int)(4096.0f * GetTaggedValueAsFloat((struct TaggedValue02030b44*)((char*)v + 0x10)));
        break;
    case 1:
        node->x = (short)GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)v + 8));
        node->y = (short)(int)(4096.0f * GetTaggedValueAsFloat((struct TaggedValue02030b44*)((char*)v + 0x10)));
        break;
    }
    node->tag = 0x75;
