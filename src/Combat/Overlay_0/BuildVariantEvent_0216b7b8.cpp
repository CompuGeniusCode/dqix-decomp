...
extern "C" ARM int func_ov000_0216b7b8(char* arg) {
    ...
    node->unused = 0;
    node->tag = 0x3b;
    node->b8 = (GetIntFromVariant02030b0c((struct Variant02030b0c*)arg) & 0xff) - 0x1a;
    node->b9 = (GetIntFromVariant02030b0c((struct Variant02030b0c*)(arg + 0x8)) & 0xff) - 0x1a;
    char* text = (char*)GetField4IfField0Zero((struct Struct02030b7c*)(arg + 0x10));
    if (text != NULL) {
