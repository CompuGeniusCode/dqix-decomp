...
extern "C" ARM int func_ov000_0216b478(struct Variant02030b0c* v, int count) {
    ...
    char* copied = 0;
    int flagC = 1;
    func_0200f374(&zeroVec, 6);

    int intVal = GetIntFromVariant02030b0c(v);
    byteVal = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)v + 8)) - 0x1a;

    char* strPtr = (char*)GetField4IfField0Zero((struct Struct02030b7c*)((char*)v + 0x10));
    if (strPtr != 0) {
    ...
    if (count >= 4) {
        flagC = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)v + 0x18));
    }
    ...
    node->half18 = 0;
    node->pad10 = 0;
    CopyVec3s_02030fc8(&node->vec, &zeroVec);
    node->flag1a = 1;
