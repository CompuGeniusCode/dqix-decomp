...
// USA: func_ov000_02177330
ARM int ApplyElemFieldsSlot1(void* obj) {
	void* buf = *(void**)(GetGlobalField0x1c020421a0() + 0x5c);
	memset(buf, 0, 0x960);
	func_ov000_0217737c(obj, buf);
	return TryApplyElemFields0205d5d0((StructA0205d5d0*)((char*)obj + 0x188), 1, (int)buf, 1, 0);
}
