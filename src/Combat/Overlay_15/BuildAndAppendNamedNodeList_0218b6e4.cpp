...
extern "C" ARM int func_ov015_0218b6e4(char* obj, int count) {
    char* base = obj;
    obj = obj + 8;
    char* n0 = (char*)GetField4IfField0Zero((struct Struct02030b7c*)base);
    ...
    while (i < count) {
        ...
        char* name = (char*)GetField4IfField0Zero((struct Struct02030b7c*)obj);
        int v1 = _Z25GetIntFromVariant02030b0cP15Variant02030b0c((struct Variant02030b0c*)(obj + 8));
        char* v2addr = obj + 0x10;
        obj = obj + 0x18;
        int v2 = _Z25GetIntFromVariant02030b0cP15Variant02030b0c((struct Variant02030b0c*)v2addr);
