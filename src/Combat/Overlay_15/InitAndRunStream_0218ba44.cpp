...
extern "C" int _Z22RunLoopIfValid02030774P14Struct02030774(struct Struct02030774* p);
...
extern "C" ARM void func_ov015_0218ba44(void* self, const char* path) {
    ...
    if (buffer != 0) {
        ...
        func_0203066c(&local, &data_ov015_02193fa0);
        InitBufferReader((struct StreamState*)&local, (struct StreamHeader*)buffer, length);
        _Z22RunLoopIfValid02030774P14Struct02030774((struct Struct02030774*)&local);
    }
