...
extern "C" ARM int func_ov015_0218df0c(void* self, int* desc) {
    ...
    if (buffer == 0) {
        ...
        params.one = onePtr;
        func_02036804(*(void**)((char*)self + 0x24), &params, 0);

        struct Vec3Words02193cfc v = data_ov015_02193cfc;
        StoreVec3AsShortsAt0x5c((unsigned char*)*(void**)((char*)self + 0x24), (int*)&v);

        func_020370a0(*(void**)((char*)self + 0x24), 0, *(int*)((char*)self + 0x44));
    }
