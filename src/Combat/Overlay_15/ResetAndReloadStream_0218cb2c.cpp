...
extern "C" void _Z27RemoveMatchingNodes02037364P17Container02037364i(struct Container02037364* obj, int key);

extern "C" void _Z26ResetStreamContext02037138Ph(unsigned char* obj);
...
extern "C" ARM void func_ov015_0218cb2c(void* self, int val) {
    ...
    _Z27RemoveMatchingNodes02037364P17Container02037364i((struct Container02037364*)*(void**)(base + 0x24), 3);
    if (val != 0) {
        ...
        if (buffer != 0) {
            ...
            params.one = 1;
            params.pad20 = 3;
            func_02036804(*(void**)(base + 0x24), &params, 0);
        }

        BackgroundLoader::RemoveLockGlobal();
        allocator.Destroy();
    }
    _Z26ResetStreamContext02037138Ph(*(unsigned char**)(base + 0x24));
    func_020370a0(*(void**)(base + 0x24), 0, *(int*)(base + 0x44));
}
