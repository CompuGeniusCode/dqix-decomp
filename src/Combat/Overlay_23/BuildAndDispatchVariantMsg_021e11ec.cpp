...
ARM int BuildAndDispatchVariantMsg_021e11ec(void* objRaw) {
    ...
    short v0 = (short)_ZNK6Script9Parameter5ToIntEv(obj);
    ...
    Init_021e12cc(&local);
    local.c = v0;
    local.d = _ZNK6Script9Parameter5ToIntEv((struct Variant02030b0c*)((char*)obj + 8));
    local.e = _ZNK6Script9Parameter5ToIntEv((struct Variant02030b0c*)((char*)obj + 0x10));
    local.rest = _ZNK6Script9Parameter5ToIntEv((struct Variant02030b0c*)((char*)obj + 0x18));
    local.f = _ZNK6Script9Parameter5ToIntEv((struct Variant02030b0c*)((char*)obj + 0x20));
