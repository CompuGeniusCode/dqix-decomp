...
extern "C" void _Z22ClearBitRange_021f6c3cPvjjj(void* a, int b, int c, int d);
...
ARM void ApplyFieldsToObj_021fb640(void* p, void* obj) {
    _Z22ClearBitRange_021f6c3cPvjjj(obj, ((unsigned char*)p)[0x7e], *(unsigned short*)((char*)p + 0x90), 1);
