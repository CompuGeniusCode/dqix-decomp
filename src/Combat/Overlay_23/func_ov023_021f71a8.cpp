...
extern "C" void func_ov023_021f7290(void* obj, void* keyObj, int out1, int out2);
...
// USA: func_ov023_021f71a8
extern "C" ARM void func_ov023_021f71a8(struct Obj021f71a8* obj, void* keyObj) {
    ...
    if (GetFileInNarc((void*)out1, obj->f10, (const void**)&p, &n, 0)) {
        func_ov023_021f7290(obj, keyObj, out1, out2);
        obj->field1c = 2;
        return;
    }
