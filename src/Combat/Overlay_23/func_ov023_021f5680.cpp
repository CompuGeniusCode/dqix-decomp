...
extern "C" ARM int func_ov023_021f5680(struct Variant02030b0c* obj) {
    ...
    int v0 = GetIntFromVariant02030b0c(obj);
    int v1 = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)obj + 8));
    int v2 = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)obj + 0x10));
    int v3 = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)obj + 0x18));
