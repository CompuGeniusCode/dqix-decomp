...
void* EnqueueEventType25_0215a6dc(void* ctx, int a);

// USA: func_ov001_021634a8
ARM int DispatchEnqueueType25_021634a8(void* obj) {
    ...
    EnqueueEventType25_0215a6dc(ctx, a);
    return 1;
}
