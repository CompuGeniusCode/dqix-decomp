...
extern "C" void _Z19SetShorts0x5cTo0x60P14Shorts5c_374e0sss(Shorts5c_374e0* obj, short a, short b, short c);
...
extern "C" ARM int func_ov001_02164754(Entry_02164754* table, int index, short arg2, short arg3, int arg4) {
    ...
    switch (entry->type) {
        ...
        case 5:
            ...
            ((SetShorts0x5cTo0x60WideFn_02164754)_Z19SetShorts0x5cTo0x60P14Shorts5c_374e0sss)((Shorts5c_374e0*)member, arg2, arg3, arg4);
            return 1;
        case 6:
            member = entry->field_c;
            if (member == 0) return 0;
