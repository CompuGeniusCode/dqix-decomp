...
void InitEntryFromArgs_0215a550(int a, char* name, int b, int c);

// USA: func_ov001_0215c298  (semantic: MakeEntryFromArgsWithCount_0215c298)
extern "C" ARM int func_ov001_0215c298(char* self, int mode) {
    int c = 0x1000;
    int b;
    ...
    InitEntryFromArgs_0215a550((int)ctx, name, b, c);
    return 1;
}
