...
struct Entry0215ffc0 { char pad[0x80]; int a, b, c; };

// USA: func_ov001_0215ffc0
extern "C" ARM int func_ov001_0215ffc0(char* obj, int count) {
    char* orig = obj;
    obj = obj + 8;
    int idx = func_ov017_021d60f4(orig);
    Entry0215ffc0* e = (Entry0215ffc0*)func_ov001_0215ab20(idx);
    if (e == NULL) return 0;
