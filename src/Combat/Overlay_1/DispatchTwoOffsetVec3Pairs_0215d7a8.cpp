...
extern "C" void func_ov001_0215907c(void* node, EventVec3 v1, EventVec3 v2);

struct Data24_0215d7a8 { char pad[0x24]; void* field24; };
extern Data24_0215d7a8 data_ov001_02165880;

// USA: func_ov001_0215d7a8
ARM int DispatchTwoOffsetVec3Pairs_0215d7a8(void* self) {
    EventVec3 v1;
    memset(&v1, 0, 0xc);
    EventVec3 v2;
    memset(&v2, 0, 0xc);
    ...
    func_ov001_0215907c(node, v1, v2);
    return 1;
}
