...
struct ListNode_0215fc48 {
    ...
    char pad30[0x40];
    struct ListNode_0215fc48* next;
};

// USA: func_ov001_0215fc48  (semantic: SetNodeFlagAndNotifyVariantC_0215fc48)
extern "C" ARM int func_ov001_0215fc48(char* args, int count) {
