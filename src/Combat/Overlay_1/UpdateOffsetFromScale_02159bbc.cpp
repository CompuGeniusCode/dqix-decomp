...
extern "C" void _Z12SubtractVec3P4Vec3S0_S0_(Vec3_02159bbc*, Vec3_02159bbc*, Vec3_02159bbc*);
extern "C" void _Z7AddVec3P4Vec3S0_S0_(Vec3_02159bbc*, Vec3_02159bbc*, Vec3_02159bbc*);
extern "C" int _Z23HwDivideRounded020c2bf4jj(unsigned int, unsigned int);
extern "C" void _Z22ScaleVec3Fixed02030e2cP17Vec3Fixed02030e2ciS0_(Vec3_02159bbc*, int, Vec3_02159bbc*);
...
extern "C" ARM int func_ov001_02159bbc(struct A02159bbc* a, struct B02159bbc* b) {
    ...
    if (counter <= 0) {
        ...
        _Z12SubtractVec3P4Vec3S0_S0_(&a->pos, &delta1, &delta2);
        b->outVec.x = _Z23HwDivideRounded020c2bf4jj(delta2.x, scaleShifted);
        b->outVec.y = _Z23HwDivideRounded020c2bf4jj(delta2.y, scaleShifted);
        b->outVec.z = _Z23HwDivideRounded020c2bf4jj(delta2.z, scaleShifted);
    } else {
        Vec3_02159bbc tmp = b->outVec;
        int divScale = _Z23HwDivideRounded020c2bf4jj(scaledCount, 0x2000);
        _Z22ScaleVec3Fixed02030e2cP17Vec3Fixed02030e2ciS0_(&tmp, divScale, &tmp);
        Vec3_02159bbc sum;
        func_ov001_02164808(data_ov001_02165884, b->fwdVal, &sum);
        _Z7AddVec3P4Vec3S0_S0_(&sum, &tmp, &sum);
