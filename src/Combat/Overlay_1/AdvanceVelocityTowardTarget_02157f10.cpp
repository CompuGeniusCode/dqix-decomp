...
extern "C" ARM int func_ov001_02157f10(void* a, void* b) {
    ...
    if (*(int*)(pB + 0x38) <= 0) {
        ...
        SubtractVec3((struct Vec3*)(pA + 0x4), (struct Vec3*)(pB + 0x4c), &diff);
        *(int*)(pB + 0xb4) = HwDivideRounded020c2bf4(diff.x, denom);
        *(int*)(pB + 0xb8) = HwDivideRounded020c2bf4(diff.y, denom);
        *(int*)(pB + 0xbc) = HwDivideRounded020c2bf4(diff.z, denom);
    }
    ...
    AddVec3((struct Vec3*)(pB + 0x4c), (struct Vec3*)&vel, (struct Vec3*)(pB + 0x4c));
