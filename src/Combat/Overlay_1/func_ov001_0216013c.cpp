...
extern "C" void _ZN8Object3D24MaybeSetRegularAnimationEPKci(void* obj, void* pool, int zero);
...
extern "C" ARM int func_ov001_0216013c(int id) {
    ...
    if (type == 2 || type == 6) {
        ...
        _ZN8Object3D24MaybeSetRegularAnimationEPKci(obj2, &data_ov001_02165769, 0);
    }
