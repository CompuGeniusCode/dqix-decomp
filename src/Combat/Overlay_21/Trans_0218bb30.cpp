...
extern "C" unsigned int _Z17ResetCommandQueuev();
...
extern "C" unsigned int _Z34InvokeHandlerAndClearFlags020b3814v();
...
L60:;
    r0 = (unsigned int)_Z34InvokeHandlerAndClearFlags020b3814v();
    r0 = (unsigned int)_Z17ResetCommandQueuev();
