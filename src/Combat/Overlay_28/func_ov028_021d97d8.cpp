...
extern "C" ARM int func_ov028_021d97d8(void* obj) {
    ...
    local.a = (short)_ZNK6Script9Parameter5ToIntEv((struct Variant02030b0c*)obj);
    local.c = _ZNK6Script9Parameter5ToIntEv((struct Variant02030b0c*)((char*)obj + 8));
    local.b = (short)_ZNK6Script9Parameter5ToIntEv((struct Variant02030b0c*)((char*)obj + 0x10));
    const char* text = (const char*)_ZNK6Script9Parameter8ToStringEv((struct Struct02030b7c*)((char*)obj + 0x18));
    if (text != 0) {
