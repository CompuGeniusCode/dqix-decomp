...
extern "C" ARM void* func_ov017_0219c6f4(char* combatant) {
    ...
    *(short*)(obj + 0x0) = *(int*)(combatant + 0x1c);
    CopyVec3((int*)(obj + 0x10), (int*)(combatant + 0x20));

    *(short*)(obj + 0x1c) = *(short*)(combatant + 0x50);
    *(unsigned char*)(obj + 0xb) = *(int*)(combatant + 0x6c);
    CopyVec3((int*)(obj + 0x30), (int*)(combatant + 0x20));

    CopyVec3((int*)(obj + 0x3c), (int*)(combatant + 0x2c));
    CopyVec3((int*)(obj + 0x48), (int*)(combatant + 0x38));
    CopyVec3((int*)(obj + 0x54), (int*)(combatant + 0x44));
