...
extern int data_ov017_021d67e8[];

// USA: func_ov017_021a0ba8
ARM void DestroyAllocatorsFromTable_021a0ba8(char* obj) {
	for (int i = 0; data_ov017_021d67e8[i] > -1; i++) {
		int off = data_ov017_021d67e8[i] * 0x14;
