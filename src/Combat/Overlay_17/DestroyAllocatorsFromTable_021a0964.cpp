...
extern int data_ov017_021d6674[];

// USA: func_ov017_021a0964
ARM void DestroyAllocatorsFromTable_021a0964(char* obj) {
	for (int i = 0; data_ov017_021d6674[i] > -1; i++) {
		int off = data_ov017_021d6674[i] * 0x14;
