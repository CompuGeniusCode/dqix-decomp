...
extern int data_ov017_021d668c[];

// USA: func_ov017_021a0d6c
ARM void DestroyAllocatorsFromTable_021a0d6c(char* obj) {
	for (int i = 0; data_ov017_021d668c[i] > -1; i++) {
		int off = data_ov017_021d668c[i] * 0x14;
