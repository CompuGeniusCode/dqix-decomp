...
int GetTableEntryEven02030c68(int angle);
int GetTableEntryOdd02030c9c(int angle);
...
extern "C" ARM int func_ov017_021ab280(struct Obj_021ab280* obj) {
    ...
    if (state == 0) {
        ...
        SetBitsInField0x6c((unsigned char*)combatant, 0x01000080);

        struct Vec3 dir;
        struct Vec3 saved = *(struct Vec3*)((char*)combatant + 0x44);
        int angleY = func_02030f30(obj->pos->angle + (int)0xffffcdc3);
        dir.x = GetTableEntryEven02030c68(angleY);
        dir.y = 0;
        dir.z = GetTableEntryOdd02030c9c(angleY);
        func_020c2f18(&dir, &dir);
        AddVec3((struct Vec3*)&obj->pos->x, &dir, &obj->vec14);
        SubtractVec3(&obj->vec14, &saved, &dir);
        func_020c2f18(&dir, &dir);
        int angle2 = func_020c338c(dir.x, dir.z);
        ...
        struct Vec3 delta;
        struct Vec3 saved = *(struct Vec3*)((char*)combatant + 0x44);
        SubtractVec3(&obj->vec14, &saved, &delta);
        Vec3LengthRounded((int*)&delta);
        SubtractVec3(&obj->vec14, &saved, &delta);
        func_020c2f18(&delta, &delta);
        int angle2 = func_020c338c(delta.x, delta.z);
        ...
        *(unsigned short*)((char*)combatant + 0xb2) = 0xa3;
        ...
        ClearBitsInField0x6c((unsigned char*)combatant, 0x01000080);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (c != 0) {
                ClearBitsInField0x6c((unsigned char*)c, 0x1000000);
            }
        }
        ...
        *(unsigned short*)(e + 0) = obj->pos->half30;
        CopyVec3((int*)(e + 0x10), (int*)&obj->pos->vecArr[0]);
        *(short*)(e + 0x1c) = obj->pos->half68;
        e[0xb] = (unsigned char)obj->pos->half6a;
        CopyVec3((int*)(e + 0x30), (int*)&obj->pos->vecArr[0]);
        CopyVec3((int*)(e + 0x3c), (int*)&obj->pos->vecArr[1]);
        CopyVec3((int*)(e + 0x48), (int*)&obj->pos->vecArr[2]);
        CopyVec3((int*)(e + 0x54), (int*)&obj->pos->vecArr[3]);
