...
extern int data_ov017_021d6668[];

// USA: func_ov017_021a0f40
ARM void DestroyAllocatorsFromTable_021a0f40(char* obj) {
	for (int i = 0; data_ov017_021d6668[i] > -1; i++) {
		int off = data_ov017_021d6668[i] * 0x14;
