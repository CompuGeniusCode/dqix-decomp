...
ARM void IncrementCombatantByteIfFlagSet_021cc320(void* unused0, Src_021cc320* src, struct BattleStruct* battleStruct) {
	struct CombatantStruct* c = GetCombatantWithFlag0x100(battleStruct, src->combatantId);
	if (c != 0) {
