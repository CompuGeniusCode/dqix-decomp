...
extern unsigned int GetSubBg0CharBaseAddr(void);
extern int data_020f2270;

// USA: func_020c5e38
ARM int TransferSubBg0CharData(int arg0, int arg1, unsigned int arg2) {
    unsigned int base = GetSubBg0CharBaseAddr();
