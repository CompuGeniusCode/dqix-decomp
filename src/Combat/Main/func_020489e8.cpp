...
extern "C" float func_02034a30(struct Obj02034a30* obj, int param);
...
extern "C" ARM void func_020489e8(struct Obj020489e8* obj) {
    ...
    if (obj->field13c->flags & 1) {
        CopyVec3(obj->field13c->vec, obj->vecSrc);
    ...
    if (isNonzero) {
        ...
        int bits = GetField0x41Bits0To4((struct Bits41_37474*)obj);
        ScaleU5ValueToU16(&((struct Obj02034a30*)((char*)obj->field13c + 0x60))->field0, (float)bits);
        float result = func_02034a30((struct Obj02034a30*)((char*)obj->field13c + 0x60), threshold);
