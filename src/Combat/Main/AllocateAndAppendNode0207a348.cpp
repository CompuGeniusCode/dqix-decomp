...
ARM int AllocateAndAppendNode0207a348(struct Pair0207a348* p, int count) {
    ...
    void* name = _ZNK6Script9Parameter8ToStringEv(&p->a);
    void* buf2 = _ZNK6Script9Parameter8ToStringEv(&p->b);
    ...
    _ZN8Object3D14ShallowCloneToEPS_(node, allocated);
    _ZN8Object3D17SetInheritedAlphaEi((struct S02037418*)allocated, 0x1f);
