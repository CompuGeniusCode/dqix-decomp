...
struct Obj374b0;
void* GetField4PtrFromField10(struct Obj374b0* obj);

struct List_020347b4;
struct Entry_020347b4;
extern "C" Entry_020347b4* _Z24GetEntryFromList020347b4P13List_020347b4i(List_020347b4* list, int index);
...
extern "C" ARM void func_0208ec78(struct Param0208ec78* p0) {
    ...
    if (p0->field8 != 0) {
        void* field4 = GetField4PtrFromField10(p0->field8);
        if (field4 != 0) {
            Entry_020347b4* rate = _Z24GetEntryFromList020347b4P13List_020347b4i((List_020347b4*)field4, 0);
            if (rate != 0) {
                r = (char*)rate;
