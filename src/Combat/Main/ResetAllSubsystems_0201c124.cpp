...
void ResetStructReturnSelf(void* p);
void Init0207b98c(char* p);
void ClearStruct0201e248(void* p);
...
extern "C" ARM void* func_0201c124(void* self) {
    ...
    func_0200ef44((char*)self + 0x498, 2, 0xac, (void*)ResetStructReturnSelf);
    Init0207b98c((char*)self + 0x10c);
    ClearStruct0201e248((char*)self + 0x6c);
    return self;
}
