...
ARM void SetupFieldsFromParam02048850(struct Obj02048850* obj, struct Param02048850* p) {
    obj->field144 = p;
    _ZN8Object3D9SetRadiusEi((struct IntField0x64_020377c4*)(obj), (int)(p->fieldC << 2));
    _ZN8Object3D9SetHeightEi((struct IntField0x68_020377b4*)(obj), (int)(obj->field144->fieldE));
}
