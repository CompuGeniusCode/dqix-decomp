...
// USA: func_020c2208  (semantic: MTX_Copy44To43_)
//
// PROVENANCE: pokediamond/arm9/lib/NitroSDK/src/FX_mtx44.c -- MTX_Copy44To43_. Also asm in
...
// from a field copy.
extern "C" ARM asm void func_020c2208(struct Mtx44_020c2208 *src, struct Mtx43_020c2208 *dst) {
    ldmia r0!, {r2, r3, r12}
    add r0, r0, #4
    stmia r1!, {r2, r3, r12}
    ldmia r0!, {r2, r3, r12}
