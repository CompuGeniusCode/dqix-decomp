...
extern "C" ARM int func_0206ed44(void* param0) {
    ...
    short* arr;
    int key;
    key = GetIntFromVariant02030b0c((struct Variant02030b0c*)param0);
    ...
    node->key = (short)key;
    node->f2 = (unsigned char)GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)param0 + 8));
    node->f3 = (unsigned char)GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)param0 + 0x10));
    node->f4 = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)param0 + 0x18));
    node->f8 = (short)(int)(4096.0f * GetTaggedValueAsFloat((struct TaggedValue02030b44*)((char*)param0 + 0x20)));
    node->fa = (short)GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)param0 + 0x28));
    node->fc = (short)GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)param0 + 0x30));
