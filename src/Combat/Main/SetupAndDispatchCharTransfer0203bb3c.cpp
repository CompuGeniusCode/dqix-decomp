...
ARM void SetupAndDispatchCharTransfer0203bb3c(struct Obj0203bb3c* obj, char* src, SafeAllocator* allocator, int category, unsigned short arg5) {
    ...
    if (obj->byte2 == 0) {
        ...
        switch (category) {
        case 0: CopyToPaletteA((int)src, 0, 0x20); break;
        case 1: CopyToPaletteB((int)src, 0, 0x20); break;
        }
        src += 0x20;
        ...
        switch (category) {
        case 0: CopyToPaletteA((int)src, 0, 0x200); break;
        case 1: CopyToPaletteB((int)src, 0, 0x200); break;
        }
        src += 0x200;
