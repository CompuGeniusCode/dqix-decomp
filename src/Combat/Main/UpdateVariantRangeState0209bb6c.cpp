...
ARM int UpdateVariantRangeState0209bb6c(struct Variant02030b0c* obj, int count) {
    ...
    {
        int val = GetIntFromVariant02030b0c(obj);
    ...
    d = 0;
    if (count > 1) {
        a = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)obj + 8));
        b = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)obj + 0x10));
        c = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)obj + 0x18));
        d = GetIntFromVariant02030b0c((struct Variant02030b0c*)((char*)obj + 0x20));
    }
