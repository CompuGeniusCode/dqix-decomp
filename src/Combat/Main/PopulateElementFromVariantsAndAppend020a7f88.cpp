...
ARM int PopulateElementFromVariantsAndAppend(unsigned char* src) {
    ...
    elem.b0 = (unsigned char)GetIntFromVariant02030b0c((Variant02030b0c*)src);
    elem.b2 = (unsigned char)GetIntFromVariant02030b0c((Variant02030b0c*)(src + 0x8));
    char* name = (char*)GetField4IfField0Zero((Struct02030b7c*)(src + 0x10));
    elem.h18 = (unsigned short)GetIntFromVariant02030b0c((Variant02030b0c*)(src + 0x18));

    char* blk = (char*)&elem.block;
    *(short*)(blk + 0) = (short)GetIntFromVariant02030b0c((Variant02030b0c*)(src + 0x20));
    *(short*)(blk + 2) = (short)(int)(GetTaggedValueAsFloat((TaggedValue02030b44*)(src + 0x28)) * 4096.0f);
    *(int*)(blk + 4) = (int)(GetTaggedValueAsFloat((TaggedValue02030b44*)(src + 0x30)) * 4096.0f);
    *(int*)(blk + 8) = (int)(GetTaggedValueAsFloat((TaggedValue02030b44*)(src + 0x38)) * 4096.0f);
    *(int*)(blk + 0xc) = (int)(GetTaggedValueAsFloat((TaggedValue02030b44*)(src + 0x40)) * 4096.0f);

    elem.h1a = (unsigned short)GetIntFromVariant02030b0c((Variant02030b0c*)(src + 0x48));
    elem.h1c = (unsigned short)GetIntFromVariant02030b0c((Variant02030b0c*)(src + 0x50));

    elem.w20 = (unsigned int)(int)(GetTaggedValueAsFloat((TaggedValue02030b44*)(src + 0x58)) * 4096.0f);
    elem.w24 = (unsigned int)(int)(GetTaggedValueAsFloat((TaggedValue02030b44*)(src + 0x60)) * 4096.0f);
