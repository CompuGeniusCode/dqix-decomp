...
// USA: func_020e62b4
extern "C" __declspec(initcode) ARM void __sinit_020e62b4(void) {
    _Z25InitAndReturnSelf0208f4bcP14Struct0208e9f4(&data_02109020);
    __register_global_object((int)&data_02109020, (int)_Z25InitAndReturnSelf0208f4d0Pv, &data_02109014);
}
