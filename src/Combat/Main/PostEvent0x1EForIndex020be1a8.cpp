...
typedef void (*EventCallback020be1a8)(int, int, int, int);
extern "C" int func_020be09c(unsigned int index, EventCallback020be1a8 callback, void* ctx, unsigned int index2, int b);
...
// USA: func_020be1a8
ARM int PostEvent0x1EForIndex020be1a8(unsigned int index, int b, int flag) {
