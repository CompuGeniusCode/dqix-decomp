...
// USA: func_020c21dc
//
// PROVENANCE: pokediamond/arm9/lib/NitroSDK/src/FX_mtx44.c -- MTX_Identity44_. NitroSDK fx: set 4x4 fixed-point identity matrix.
...
ARM asm void InitStruct020c21dc(void *dst) {
    mov r2, #0x1000
    mov r3, #0
    stmia r0!, {r2, r3}
    mov r1, #0
