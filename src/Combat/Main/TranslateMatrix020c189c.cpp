...
// USA: func_020c189c  (semantic: TranslateMatrix020c189c)
extern "C" ARM void func_020c189c(struct FixedMtx43_189c* src, struct FixedMtx43_189c* dst, int x, int y, int z) {
