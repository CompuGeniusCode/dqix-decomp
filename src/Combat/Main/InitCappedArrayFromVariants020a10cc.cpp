...
ARM int InitCappedArrayFromVariants020a10cc(struct Vec4Variant020a10cc* arg0) {
    ...
    unsigned short a = (unsigned short)GetIntFromVariant02030b0c(&arg0->v0);
    unsigned short b = (unsigned short)GetIntFromVariant02030b0c(&arg0->v1);
    unsigned short c = (unsigned short)GetIntFromVariant02030b0c(&arg0->v2);
    unsigned short d = (unsigned short)GetIntFromVariant02030b0c(&arg0->v3);
