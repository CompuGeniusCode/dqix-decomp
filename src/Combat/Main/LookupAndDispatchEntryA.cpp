...
extern "C" void func_02034820(struct Table02034768* table, void* payload);

struct GlobalTableSlot02104b10_344a8 {
    void* alloc;
    struct Table02034768* table;
};
extern struct GlobalTableSlot02104b10_344a8 data_02104b10;

struct Payload020344a8 {
    short variantValue;
    short nameIndex;
    short scaledValue;
    int unused;
...
// USA: func_020344a8
ARM int LookupAndDispatchEntryA(struct Struct02030b7c* param) {
    struct Payload020344a8 payload;
    const char* name;
    int index;
    float floatVal;
    int scaled;
    ...
    func_02034820(data_02104b10.table, &payload);
    return 1;
}
