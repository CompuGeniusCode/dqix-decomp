...
ARM int SetNodeVec4FromVariant0206c614(void* param0) {
    ...
    node->value0x24 = (int)(4096.0f * GetTaggedValueAsFloat((struct TaggedValue02030b44*)((char*)param0 + 8)));
    node->value0x28 = (int)(4096.0f * GetTaggedValueAsFloat((struct TaggedValue02030b44*)((char*)param0 + 0x10)));
    node->value0x2c = (int)(4096.0f * GetTaggedValueAsFloat((struct TaggedValue02030b44*)((char*)param0 + 0x18)));
    node->value0x30 = (int)(4096.0f * GetTaggedValueAsFloat((struct TaggedValue02030b44*)((char*)param0 + 0x20)));
