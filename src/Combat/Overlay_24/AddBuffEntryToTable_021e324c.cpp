...
ARM unsigned long long AddBuffEntryToTable_021e324c(struct Obj_021e324c* obj, int unused, int id) {
	...
	local.lo = 0;
	local.hi = 0;
	if (CheckFlag0x2AndKind1((struct Combatant_20885b4*)c->currentStats) || CheckFlag0x2AndState2((struct S88514*)c->currentStats)) {
		ClearFlag0x2AndKind((struct Combatant_2088644*)c->currentStats);
