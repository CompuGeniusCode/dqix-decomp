...
struct RngHolder_021d9c7c { struct Random* rng; };

// USA: func_ov024_021d9c7c
ARM int RandomScaleField6cMaxOfTwo5x50_021d9c7c(struct RngHolder_021d9c7c* holder, unsigned short category, int unused1, int unused2, int unused3, int fallback) {
    int inRange = 0;
    if (category <= 3) {
        inRange = 1;
    }
    ...
    float a = (50.0f + 5.0f * value) * randomFactor1;
