...
// USA: func_ov004_02156cb8  (semantic: DispatchStatusByNormalizedKind_02156cb8)
extern "C" ARM int func_ov004_02156cb8(void* a) {
    ...
    void* node = func_ov023_021f6880(func_ov011_021849c8(a), 0x28);
    if (!node) return 0;
