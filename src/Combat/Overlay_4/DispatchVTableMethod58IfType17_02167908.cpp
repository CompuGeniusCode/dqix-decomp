...
// USA: func_ov004_02167908  (semantic: DispatchVTableMethod58IfType17_02167908)
extern "C" ARM int func_ov004_02167908(void* a, int key) {
    VObj02167908* node = (VObj02167908*)func_ov023_021f6880(func_ov011_021849c8(a), key);
    if (!node) goto ret0;
