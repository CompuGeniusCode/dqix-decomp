...
extern "C" VObj02154da8* func_ov023_021f6880(void*, int);

// USA: func_ov004_02154da8  (semantic: DispatchTwelveBuffEntries_02154da8)
extern "C" ARM int func_ov004_02154da8(void* a1) {
    VObj02154da8* obj = func_ov023_021f6880(func_ov011_021849c8(a1), 0x39);
    if (!obj) return 0;
    ...
    short j = 0;
    for (; j <= 0xb; key++, j++) {
        if (func_ov023_021e1de8(r, -1, 0, j) == 0) {
