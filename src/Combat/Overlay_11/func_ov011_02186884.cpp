...
extern "C" int func_ov023_021fbb64(void* obj, void* ctx, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10);
...
struct Event02186884 { void* vtable; char pad[0x40 - 4]; };

// USA: func_ov011_02186884  (semantic: AllocateAndQueueEvent40_02186884)
extern "C" ARM int func_ov011_02186884(char* obj) {
    ...
    int v3 = (int)GetTaggedValueAsFloat_02184c4c((struct TaggedNumber02184c4c*)(obj + 0x18));
    int v4 = (int)GetTaggedValueAsFloat_02184c4c((struct TaggedNumber02184c4c*)(obj + 0x20));
    ...
    int v7 = GetTaggedValueAsInt_02184c30((struct TaggedNumber02184c30*)(obj + 0x38));
    int v8 = GetTaggedValueAsInt_02184c30((struct TaggedNumber02184c30*)(obj + 0x40));
    ...
    void* slot = ((SafeAllocator*)((char*)node + 4))->Allocate(0x40);
    if (slot == 0) return 0;

    struct Event02186884 local;
    local.vtable = &data_ov023_021ff078;
    memcpy(slot, &local, sizeof(Event02186884));

    if (func_ov023_021fbb64(slot, ctx, v0, v1, v2, v3, v4, v5, v6, v7, v8) == 0) return 0;
