...
// USA: func_ov011_02186e54
extern "C" ARM int func_ov011_02186e54(struct TaggedNumber02184c30* a) {
    ...
    ((void (*)(void*, unsigned short))SetFieldShortAt46_021f9c60)(node, (unsigned short)val2);
    return 0;
}
