...
extern "C" __declspec(initcode) ARM void func_020e66a0(void) {
    int a = (int)&data_02114e30;
    BlankFunction02012298();
    func_0200efd0(a, (int)BlankFunction0201238c, &data_02114e14);
    int b = (int)&data_02114e54;
    BlankFunction02012530();
    func_0200efd0(b, (int)EmptyStub02012534, &data_02114e08);
