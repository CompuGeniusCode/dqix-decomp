...
extern "C" int ReplaceBinExtensionWithNat020e55c0(char* dst, const char* fmt);
...
// USA: func_020e553c
ARM void* GetFileDataMaybeGp020e553c(const char* path, unsigned int* outSize, void* unused, const char* gp2Path) {
    char buf[0x40];
    void* result;
    if (path == 0) return 0;
    *outSize = 0;
    ReplaceBinExtensionWithNat020e55c0(buf, path);
    if (gp2Path == 0) {
