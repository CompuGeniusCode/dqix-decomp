        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (*handle > -1) {
                if (func_0202fdd0(dataResult, *((short*)(obj + 0xbf4) + i))) {
                    struct NodeRec021e5020* nodes = (struct NodeRec021e5020*)obj;
                    ResetAndUnlinkNode02037330((unsigned char*)&nodes[i]);
                    int allocOff = i * 0x14;
                    ...
                    if (out2 != 0) {
                        ...
                        AllocateAndInitBuffer02036084((struct Obj02036084*)&nodes[i], (SafeAllocator*)(obj + 0x6b8 + allocOff), out1, out2, 0);
                        BackupPairTables0207dfac(obj + 0x794 + pairOff);
                        if (i == 4 && *(int*)(obj + 0x20c) != 0) {
                            func_0207ea8c(*(void**)((char*)&nodes[i] + 8));
                        }
                    }
