...
struct NodeRec021e5020 { unsigned char pad[0xac]; };
    ...
    if (*(unsigned char*)(obj + 0xc12) != 0) {
        ...
        *(unsigned char*)(obj + 0xc12) = 0;
        ...
        for (unsigned int i = 0; i < 10; i++) {
            if (*((short*)(obj + 0xbf4) + i) > -1) {
                if (func_0202fdd0(dataResult, *((short*)(obj + 0xbf4) + i))) {
                    unsigned int nodeOff = (unsigned int)i * 0xacu;
                    ResetAndUnlinkNode02037330((unsigned char*)obj + nodeOff);
                    int allocOff = i * 0x14;
                    ...
                    if (out2 != 0) {
                        ...
                        AllocateAndInitBuffer02036084((struct Obj02036084*)(obj + nodeOff), (SafeAllocator*)(obj + 0x6b8 + allocOff), out1, out2, 0);
                        BackupPairTables0207dfac(obj + 0x794 + pairOff);
                        if (i == 4 && *(int*)(obj + 0x20c) != 0) {
                            func_0207ea8c(*(void**)(obj + nodeOff + 8));
                        }
                    }
